...
fn propose_unmatched_splits_brand_size_and_skips_linked_existing_and_duplicates() {
    ...
    fake.products
        .push(product("p1", "Diesel Fuel For Life EDT"));
    ...
    assert_eq!(
        ...
        price_hunter_core::application::imports::ProposedProduct {
            ...
            name: "moschino Gold Fresh Couture EDP".to_string(),
        }
    );
    assert_eq!(
        proposals[1],
        price_hunter_core::application::imports::ProposedProduct {
            ...
            name: "Adidas Vibes Smooth Pace EDP Unisex".to_string(),
        }
    );
}
...
fn create_product_records_and_reports_already_exists() {
    ...
    assert_eq!(
        ...
        vec![(
            ...
            "moschino Gold Fresh Couture EDP".to_string(),
        )]
    );
}
