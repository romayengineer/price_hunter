...
- [x] for -match-products the time it takes for complete is time = products * provider_products * factor, need smart optimizations, for example length-bound optimization for bigram dice coefficient and other optimizations
